...
**This section follows the theory of the reference:**
J. Coulter, B. Rajkov, M. Simoncelli. (2025).
_Coupled electron-phonon hydrodynamics and viscous thermoelectric equations._
available at this link ().

Here, we outline the high-level perspective of the theory behind this development, but encourage you to study the paper before using it. 
